...
| **Event ID 9: Disk space is insufficient for OS migration** | Migration requires a minimum of 30 GB of free space. If this event occurs, [the Teams Rooms on Windows recovery image](#error-during-migration) will need to be used to complete the migration. |
